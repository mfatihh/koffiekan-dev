...
<div class="row">
    <div class="col-md-8" style="background:#f2f2f2;padding:0 25px 25px 25px;"><br><br>
        <table class="table" style="color:#686868;">
            ...
            <tr>
                ...
                <th class="text-right" style="color:#843763;">{{ formatRp($transaction['total'] - $transaction['total']*$transaction['diskon']/100  + $transaction->ongkir - $transaction->potongan_harga)}}</th>
            </tr>
        </table>
